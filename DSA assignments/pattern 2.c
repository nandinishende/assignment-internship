//sam is making a pattern an n-dimensional array represented by  the pattern nxn filled with '*'.  an n/2 represented by lower triangle he is given a number n, and he has to make a pattern of n rows and n columns. the pattern is as follows:
#include <stdio.h>
#include <stdlib.h>
